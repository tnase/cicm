...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 07 Janvier 2018 à 15:56
...
--
ALTER TABLE `services`
  MODIFY `ordre` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=525;
--
-- AUTO_INCREMENT pour la table `taxonomie`
--
ALTER TABLE `taxonomie`
  MODIFY `code_taxonomy` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
