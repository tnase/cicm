...
$champ = array (" code_service","standing","prix_unitaire","statut","prix_achat");
    $table = "services" ;
    $clausesChambres = array(" services.categorie='salle'"  ," services.desription='pivot'");
    ...
    while($p=$resultSetChambres->fetch()){
        if ($p->statut=="libre"){
            echo "<tr>" ;
                echo"<th scope=row ><input type='checkbox' id=".str_replace(".","-",$p->code_service)." name=idSalle".$i." value=".$p->code_service." ></th>" ;
            ...
            echo "<tr>" ;
                echo"<th scope=row ><input type='checkbox' name=idSalle".$i." id=".str_replace(".","-",$p->code_service)." value=".$p->code_service." id=".$p->code_service."></th>" ;
                echo"<td ><u>".$p->code_service."</u></td>" ;
                echo"<td>".$p->standing."</td>" ;
                echo"<td>".$p->prix_unitaire."</td>" ;
